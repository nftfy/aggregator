...
type ActivityQuery = NonNullable<Exclude<Parameters<typeof useCollectionActivity>['0'], boolean>>

const CollectionActivityTab: FC<Props> = ({ collectionId }) => {
  const [activityTypes, setActivityTypes] = useState<ActivityQuery['types']>(['sale'])
    ...
    <ActivityTable
      ...
      emptyPlaceholder={
        <div className='mt-20 mb-20 flex w-full flex-col justify-center'>
          <img src='/magnifying-glass.svg' className='h-[59px]' alt='Magnifying Glass' />
          <div className='reservoir-h6 mt-4 mb-2 text-center dark:text-white'>No activity yet</div>
