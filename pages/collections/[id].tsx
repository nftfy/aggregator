  ...
  return (
    <Layout navbar={{}}>
      <>
        ...
        <div className='col-span-full sm:mx-[25px] grid pt-2 lg:col-start-2 lg:col-end-[-2]'>
          ...
          <Tabs.List className="col-span-full flex justify-center border-b border-[#D4D4D4] dark:border-[#525252]">
            {tabs.map(({ name, id }) => (
              <Tabs.Trigger
                ...
                value={id}
                className={
                  'group reservoir-h6 relative min-w-0 whitespace-nowrap border-b-2 border-transparent py-4 px-8 text-center text-darkpink-400 hover:text-black focus:z-10 radix-state-active:border-rose-500 radix-state-active:text-rose-500 dark:text-white dark:radix-state-active:border-white dark:radix-state-active:text-white'
                }
