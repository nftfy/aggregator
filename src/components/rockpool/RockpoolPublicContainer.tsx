...
export default function RockpoolPublicTable({ chainId, collectionAddress }: RockpoolPublicTableProps) {
  ...
  const handleFilter = (filter: Filter) => {
    switch (filter.key) {
      ...
      case 'floor':
        return <FloorPublicTable chainId={chainId} collectionAddress={collectionAddress} />
    }
  }
  return (
    <>
